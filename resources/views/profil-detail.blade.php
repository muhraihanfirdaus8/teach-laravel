...
@section('content')
<a href="{{ route('profil') }}" style='color:#065A82;text-decoration:none;'>← Kembali ke Daftar</a>
...
<div style='background:white;padding:24px;border-radius:10px;border:1px solid #ddd;'>
    ...
    @endif
    @if($mahasiswa->github)
        <p><strong>GitHub:</strong> <a href='https://{{ $mahasiswa->github }}'>{{ $mahasiswa->github }}</a></p>
    @endif
    @if($mahasiswa->bio)
